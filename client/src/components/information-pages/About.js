  ...
  return (
    <>
      <div className="banner about-page-section-container-left top-banner">
        ...
        <h1>Share and Fork Micro Controller Projects</h1>
      </div>
      ...
      <div className="banner fourth-banner about-page-section-container-right">
        ...
        <h1>
          With Project Builder you can fork a project's code, parts, and assembly instructions
        </h1>
      </div>
      ...
      <div className="end-about-page"></div>
    </>
  )
}
