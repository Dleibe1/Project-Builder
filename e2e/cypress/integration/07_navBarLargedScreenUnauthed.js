...
describe("As an unauthenticated user interacting with the navigation bar on a large screen", () => {
  ...
  describe("Viewing the navigation bar", () => {
    it("I can only see options for unauthenticated users and common options", () => {
    ...
    it("The burger menu for unauthenticated users is not visible", () => {
      cy.getByData("burger-menu-button-unauthed").should("not.be.visible")
    })

    it("The burger menu for authenticated users does not exist", () => {
      cy.getByData("burger-menu-button-authed").should("not.exist")
    })
  })
