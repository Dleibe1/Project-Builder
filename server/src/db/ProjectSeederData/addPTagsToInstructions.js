...
const projectInstructionsSeedData = [
	...
	signals.<br><br>RGB LED Types and Structure<br><br>RGB LEDs have three LEDs inside them \\
	...
	common anode or common cathode type just like in seven segment displays. <br><img \\
	src="https://projects.arduinocontent.cc/6ce54a92-5d7b-4a79-9bb9-14646cee8d8d.png"></img><br>Common \\
	Anode<br><br>In a common anode RGB LED, the anode of the internal LEDs are all connected \\
	...
	terminal of the power supply. <br><img \\
	src="https://projects.arduinocontent.cc/50bfbc76-b401-44e6-8806-4c07057a4c63.png"></img><br>Common \\
	Cathode<br><br>In a common cathode RGB LED, the cathode of the internal LEDs are all \\
	...
	terminal of the power supply. <br><img \\
	src="https://projects.arduinocontent.cc/a402677b-ba8b-4441-a052-cda5b140852b.png"></img><br>Basics \\
	of PWM (Pulse Width Modulation)<br><br>Pulse Width Modulation, or PWM, is a technique for \\
	...
	lines would measure 2 milliseconds each. <br><img \\
	src="https://projects.arduinocontent.cc/79c61371-7a80-4395-9e08-a4305376229c.gif"></img><br>The \\
	code below will cycle the LED through different colors, enjoy!`,
	
	`Ever wanted to know the temperature and humidity around you? If yes, this project will \\
	be very helpful for you. If no, it'll be cool anyway. What I mean is, you can use this in \\
	anything from home automations to smart watches.<br><br>What is humidity?<br><br>Humidity \\
	...
	above except the last one, you're in space or you're in the middle of a desert**.<br><br>* \\
	Correction: it means the air cannot hold any more water.<br><br>**  The air in a desert \\
	does contain some water but it is a very little amount compared to a normal place. The \\
	Sahara Desert has a mean humidity of 25%.<br><br>The world's lowest recorded relative \\
	...
	storage container, the less frequent the need for recharging. <br><img \\
	src="https://www.hibit.dev/images/posts/2024/watering_bottle.png"></img><br>We've selected \\
	the bottle shown on the image as our water reservoir. With a capacity of 1.5 liters, it \\
	should be sufficient for watering a medium-sized plant for several days.<br><br>For the \\
	...
	ensuring there is no water loss. <br><img \\
	src="https://www.hibit.dev/images/posts/2024/watering_bottom.png"></img><br>On the \\
	opposite end, there will be a water pipe directly connecting to the plant to provide \\
	hydration.<br><br>Water pump wiring<br><br>To facilitate the connection of the pump wires \\
	...
	external elements. <br><img \\
	src="https://www.hibit.dev/images/posts/2024/watering_bottle_pump_connector.png"></img><br>This \\
	approach ensures a secure and well-insulated connection, contributing to the overall \\
	reliability of the system.<br>Plants care station<br><br>The plants care station takes on \\
	...
	by enclosing all system components within the box illustrated below. <br><img \\
	src="https://www.hibit.dev/images/posts/2024/watering_box.png"></img><br>The box is easily \\
	...
	plants.<br><br>Power supply<br><br>For the entire system, a 9V battery serves as the power \\
	...
	the overall reliability of the system.<br><Control elements<br><br>The plants care station \\
	...
	automatic mode. <br><img \\
	src="https://www.hibit.dev/images/posts/2024/watering_station.png"></img><br>These \\
	user-friendly controls provide a precise and efficient means of managing your plant care \\
	routine.<br><br>Wiring schema<br><br>Creating a precise wiring schema is essential for the \\
	...
	between modules. <br><img \\
	src="https://www.hibit.dev/images/posts/2024/schemas/watering_system.png"></img><br>The \\
	above wiring schema offers a comprehensive overview of the system wiring and \\
	connections.<br><br>Calculating base resistor value<br><br>In order to compute the base \\
	...
	We have now discovered our second value: 𝛽 = 100.<br><br>Once we've established the gain, \\
	...
	relationship can be expressed mathematically as:<br><br>hFe = 𝛽 (gain) = Ic / \\
	...
	0.6V) / 2mA = 2.2kΩ<br><br>For our circuit, the suitable value for the base resistor \\
	...
	transistor into saturation.<br><br>Automated plants watering system<br><br>After going \\
	...
	areas for improvement. <br><img \\
	src="https://www.hibit.dev/images/posts/2024/watering_system_result.png"></img><br>The \\
	...
	straightforward.<br><br>Having outlined the concept of automated watering and successfully \\
	...
	reality.<br><br>Install library for DS1302<br><br>To interact with the DS1302 sensor, we \\
	...
	https://github.com/hibit-dev/ds1302/raw/master/lib/DS1302.zip<br><br>To import a library, \\
	open the Arduino IDE, go to Sketch > Include Library > Add .ZIP Library and select the \\
	library file downloaded from our GitHub repository .<br><img \\
	src="https://www.hibit.dev/images/posts/2023/arduino_import_library.png"></img><br>Then \\
	you can simply use include statement:<br>#include "virtuabotixRTC.h"<br>It will include \\
	the library with predefined functions to interact with the module.<br><br>Arduino \\
	code<br><br>This Arduino code forms the backbone of our automated watering system, \\
	...
	when the process initiates, the green LED will illuminate.<br><br>The potentiometer values \\
	...
	designated constants.<br><br>It's worth mentioning that we've opted to disable the morning \\
	...
	ready for future functionalities.<br><br>The presented Arduino code serves as the \\
	...
	operation.<br><br>Please be aware that the provided code snippet includes only the main \\
	segment.<br><br>Conclusion<br><br>In the spirit of self-made solutions, this project \\
	...
	plants, wherever they may be.<br><br>In wrapping up our journey through the practical \\
	...
	precision appear at the two ends of the audio range. <br><img \\
	src="https://projects.arduinocontent.cc/4e0bc386-4bd4-467a-8b59-084830978a17.jpg"></img><br>The \\
	...
	and we can also add more, with very small modifications to the code.<br><img \\
	src="https://projects.arduinocontent.cc/e5bffdf1-c174-47b2-aaeb-0edf30fec098.jpg"></img><br>Next, \\
	...
	materials. <br><img \\
	src="https://projects.arduinocontent.cc/68e9de6f-5336-42bc-be80-c50441f2808b.jpg"></img><br>Namely, \\
	...
	it is desirable to reduce the bandwidth by half, actually to 10 Kilohertz.<br><br>For this \\
	...
	input. The range is up to 10Khz. <br><img \\
	src="https://projects.arduinocontent.cc/c3d1c115-d49f-4b94-9b96-13111be626e6.jpg"></img><br>Now, \\
	in this case the matrix is completely filled and visually it looks much better.<br><br>As \\
	for the external appearance of the device, I tried to make a simple, but still functional \\
	version made of PVC board and glass with a thickness of 4 mm.<br><br>And finally a short \\
	conclusion.<br><br>This is an extremely simple project intended for beginners, but still \\
	...
	captivating eye animations into a clear and fun comparison.<br><br>Introducing our \\
	selections:<br><br>Option 1: Eye Animation on OLED Display by Intellar <br><img \\
	src="https://projects.arduinocontent.cc/414272c9-2c90-4576-9430-7599672fbcda.jpg"></img><br>Intellar's \\
	...
	positions. Con: Limited to three moods.<br><br>Option 2: Simple Animated Eye Using Arduino \\
	by SpiderMaf <br><img \\
	src="https://projects.arduinocontent.cc/dc1bda48-7902-4555-9369-708247c04e14.jpg"></img><br>SpiderMaf's \\
	...
	Intellar's approach.<br><br>Option 3: Akno by AbdulsalamAbbod <br><img \\
	src="https://projects.arduinocontent.cc/3f6ae98e-f7e9-40d2-8573-c242dc66d89c.jpg"></img><br>Akno \\
	...
	eye size.<br><br>Option 4:  Arduino OLED Moving Eyes by Vinny <br><img \\
	src="https://projects.arduinocontent.cc/2596309e-914d-4907-b5a0-b940e3bc6f7b.jpg"></img><br>Vinny's \\
	...
	process.<br><br>Option 5: Arduino UNO Robotic Eye Animations by Picaio <br><img \\
	src="https://projects.arduinocontent.cc/cff99131-f7ce-4295-b530-811e057734de.jpg"></img><br>Picaio \\
	...
	be challenging for beginners due to its complexity.<br><br>Whether you're a seasoned \\
	...
	creativity.<br><br>Let's animate those robotic eyes and inject some fun into your Arduino \\
	projects! 🤖👀`,
	
	`Greetings everyone, and welcome to my Instructables tutorial. Today, I'll guide you \\
	through the process of creating an Object Tracking 4-DOF Robotics Arm.<br>Project \\
	Overview:<br><br>In this project, the robotic arm will execute actions corresponding to \\
	...
	up, and down.<br><br>Without further ado, let's dive into the project and get started! \\
	...
	Servo Motors & PWM Servo Motor Driver Wiring <br><img \\
	src="https://projects.arduinocontent.cc/16e51e8c-81e8-4931-be46-69505c3bacd1.jpg"></img><br>Refer \\
	...
	side Servo -> PWM servo pin 2<br>Base Servo -> PWM servo pin 3<br><br>Step 3: PWM Servo \\
	Motor Driver & Arduino Uno Wiring<br><img \\
	src="https://projects.arduinocontent.cc/00e1a573-4371-49bf-ba42-6884f62999ad.png"></img><br>Follow \\
	the Circuit Diagram:<br>PWM Servo Motor Driver  -> Arduino Uno<br>GND   ->    GND<br>SCL   \\
	->    A4<br>SDA   ->    A5<br>VCC   ->    VIN<br><br>Step 4: Mounting the Sensors Into the \\
	Robotics Arm<br><img \\
	src="https://projects.arduinocontent.cc/fdab1aff-be31-4855-9328-99ec1bb9e356.jpg"></img><br>Follow \\
	...
	IR sensors to the left and right sides of the sensor case using hot glue.<br><br>These are \\
	all the steps required for this process.<br><br>Step 5: Ultrasonic Sensor, IR Sensor & \\
	Arduino Uno Wiring<br><img \\
	src="https://projects.arduinocontent.cc/db48a4f0-129b-4770-8e19-9e81f5a8c29d.png"></img><br>Follow \\
	the Circuit Diagram:<br><br>Ultrasonic Sensor -> Arduino Uno<br>GND -> GND ECHO -> A3 TRIG \\
	-> A2 VCC -> VIN<br><br>IR Sensor -> Arduino Uno (Right)<br>GND -> GND OUT -> A1 VCC -> \\
	VIN<br><br>IR Sensor -> Arduino Uno (left)<br>GND -> GND OUT -> A0 VCC -> VIN<br><br>Step \\
	6: Time to Upload the Sketch<br><img \\
	src="https://projects.arduinocontent.cc/efbbe392-9df2-476e-8470-157bd5dd834d.jpg"></img><br>- \\
	Now connect the USB cable to the Arduino Uno.<br>Next, upload the following code:`,
	
	`About the Project<br><br>Welcome back, tech enthusiasts! Today, I'm excited to introduce \\
	...
	building and testing this network security tool. Features & Components<br><br>ARPoLan \\
	combines several powerful components to deliver its impressive capabilities:<br><br>1.  \\
	...
	indicators for attack detection and network activity. Getting Started<br><br>I designed \\
	the PCB for ARPoLan using Altium Designer, creating a simple yet efficient two-layer \\
	layout. Here’s a breakdown of the components used: <br><img \\
	src="https://projects.arduinocontent.cc/88d1456c-cb9c-4a24-8b67-44c7d5ea7dc9.jpg"></img><br>Atmega32u4 \\
	Microcontroller: Handles USB communication and processing tasks.<br><br>W5500 Ethernet \\
	Module: Provides reliable network connectivity with an integrated hardware TCP/IP \\
	stack.<br><br>25 MHz Crystal Oscillator: Ensures precise timing for network \\
	operations.<br><br>RJ45 Ethernet Socket: Facilitates network connections with integrated \\
	status LEDs.<br><br>LM1117 Voltage Regulator: Supplies a stable 3.3V power to the \\
	W5500.<br><br>USB A Port: Allows for easy programming and data transfer.<br><br>Passive \\
	Components:<br><br>Capacitors and resistors for power stabilization and signal \\
	integrity.<br><br>The communication between the W5500 and the Atmega32u4 is handled via \\
	the SPI protocol, ensuring quick and reliable data transfer. Schematic<br><br>The PCB for \\
	...
	reliable connections between the Atmega32u4 and the W5500. <br><img \\
	src="https://projects.arduinocontent.cc/0b6d0eeb-6a94-4fd1-9568-654934207c4a.png"></img><br>Connection \\
	Table<br>Ensure the VCC pin of the W5500 is connected to a 3.3V power supply, as the \\
	module operates at 3.3V logic levels.<br><br>The SS (Slave Select) pin can be connected to \\
	any digital pin on the Arduino Pro Micro, but it must be defined correctly in the \\
	code.<br><br>Make sure the GND of the Arduino Pro Micro is connected to the GND of the \\
	W5500 module to ensure a common ground.<br><br>This setup will enable SPI communication \\
	between the Arduino Pro Micro and the W5500 Ethernet module. <br><img \\
	src="https://projects.arduinocontent.cc/519e6eda-d64e-4e1a-a08e-b4eff9fc6ea5.jpg"></img><br>Conclusion<br>Creating \\
	...
	risks.<br><br>Second Code: ARP Spoofing Next, I tested the ARP spoofing code. This script \\
	...
	demonstrated the device's potential for network security tasks.<br><br>Third Code: Network \\
	...
	PCB<br><br>If you're interested in building this project, the code and schematic are \\
	...
	the code and share your feedback or improvements.<br><br>GitHub repository: \\
	github.com/cifertech/arpolan `,
	
	`Ultrasonic sonar is devices that use sound waves with frequencies higher than the upper \\
	...
	determined using the speed of sound in air.<br><br>This time I will describe to you a \\
	...
	the image is much clearer. <br><img \\
	src="https://projects.arduinocontent.cc/77c2652f-24f9-4051-b804-ee01d27a19fb.jpg"></img><br>The \\
	...
	several resistors that serve to shift the display signal from 5V to 3.3V level<br><br>The \\
	servo and ultrasonic sensor are housed in a separate box, which I used from a previous \\
	project, and connected to the main box with flat cables. <br><img \\
	src="https://projects.arduinocontent.cc/551833cf-1265-4704-b8ed-624bc04e00fc.jpg"></img><br>Now \\
	let's see how the device works in real conditions:<br><br>At the beginning, I separated \\
	...
	the distance shown on the display. <br><img \\
	src="https://projects.arduinocontent.cc/3332450b-d347-4c5c-871c-e1d3c5db8c73.jpg"></img><br>Now \\
	...
	begins. <br><img \\
	src="https://projects.arduinocontent.cc/58696a6b-fc25-414b-bd8d-8fb2244937a5.jpg"></img><br>Obstacles \\
	...
	degrees, and then vice versa, from 0 to 180 degrees. <br><img \\
	src="https://projects.arduinocontent.cc/c08bc3f4-47b9-469f-a32a-07aa775c9549.jpg"></img><br>For \\
	...
	front display to visually simulate a real radar system. `,
	
	`In this exciting tutorial, we will show you how to build your own security camera using an \\
	ESP32-CAM and an AM312 PIR sensor to detect motion. Best of all, photos will be saved \\
	directly to an SD card!<br><br>       Throughout this video, we will guide you through the \\
	following steps:<br><br>Link projects and update in \\
	https://rogerbit.com/wprb/2023/10/captura-con-esp32/<br><br>Hardware Connection: We will \\
	show you how to connect the ESP32-CAM and the AM312 PIR sensor to your breadboard, \\
	guaranteeing correct power.<br><br>Arduino IDE Configuration: You will learn how to \\
	configure the development environment in Arduino IDE to work with the ESP32-CAM and select \\
	the appropriate board.<br><br>Programming: We will provide you with the code necessary to \\
	configure the ESP32-CAM and program it to capture images when motion is detected. \\
	Additionally, we will show how to store images on an SD card.<br><br>Try it in Real Life: \\
	You will see our motion detection system in action. We will test it in a real environment \\
	so you can see how it works.<br><br>Tips and Customization: We will share some useful tips \\
	and show you how to customize and extend this project according to your needs.<br><br>This \\
	project is perfect for creating an affordable and functional security camera for your \\
	home, office, or anywhere you want to monitor.<br><br>Electronic components<br><br>usb \\
	serial adapter <br><img \\
	src="https://rogerbit.com/wprb/wp-content/uploads/2021/07/51Lp3uhptQL.jpg"></img><br>Description<br>FTDI \\
	Basic Program Downloader USB to TTL FT232RL 3.3V 5V DTR<br><br>This is a basic breakout \\
	...
	connector.<br><br>This board has TX and RX LEDs which make it a little better to use over \\
	the FTDI cable. In fact, you can see the serial traffic on the LEDs to check if the board \\
	is working.<br><br>This board was designed to decrease the cost of Arduino development and \\
	...
	add a solder jumper if you need to switch to 3.3V.<br><br>CHARACTERISTICS<br><br>Standard \\
	interface design, compatible with a variety of Arduinos such as the Pro \\
	Mini<br><br>Original FTDI FT232 chip, stable performance<br><br>With power indicator, \\
	send, receive, working status LED indicators<br><br>With 3.3V and 5V TTL level supply \\
	options<br><br>USB to Serial TTL Module, Download STC SCM<br><br>Mini USB port \\
	connection<br><br>Standard interface, compliant with Arduino official controller; With \\
	power, sending, reveiving indicator, With 3.3V / 5V power supply; Can be used as ordinary \\
	USB to serial TTL module, download STC singlechip<br><br>Hardware \\
	introduction<br><br>Adopt FTDI company’s FT232RL chip<br><br>Lead out FT232RL chip all \\
	signal port, TTL / CMOS level<br><br>RXD/TXD send-receive communication \\
	indicator<br><br>USB power supply, can choose 5V or 3.3V interface level (if you need \\
	other level, can provide target voltage in VCC and GND pin)<br><br>Cables Dupont \\
	Introduction<br>In this project I will show you how to Decode IR Remote Control Signals' \\
	of any Remote using Arduino.<br><br>The remotes which we use in our home are basically \\
	...
	where we can control with same remote.<br><br>Working on Basic<br><br>IR remote has a \\
	...
	appliance.<br><br>System in the appliance demodulate the signals(codes) and the checks the \\
	function corresponding to it and executes it. Each function has a different \\
	code.<br><br>Every IR operated appliance has different codes for different \\
	function.<br><br>Prototype Image's<br><img \\
	src="https://projects.arduinocontent.cc/bd015441-332e-4094-a2ef-3c8a0efa3140.jpg"></img><br><br><img \\
	src="https://projects.arduinocontent.cc/ac0170b4-8181-4118-b8f2-1dc78673e266.jpg"></img><br>Hookup<br>Follow \\
	the Steps:-<br><br>Connect the First pin from the left of TSOP1738 ( OUT pin) with pin 11 \\
	of Arduino.<br><br>Hook the Middle pin ( GND pin) with the GND pin of \\
	Arduino.<br><br>Connect the third and the last pin ( VCC pin) with 5V pin of \\
	Arduino.<br><br>Uploading and Testing<br><br>Remember to install the IRremote.h \\
	library.<br><br>Copy or download the code attached with the project.<br><br>Hit upload and \\
	open serial monitor.<br><br>Take any remote you want to use or you want the codes off it \\
	and press any button.<br><br>Now, see in the serial monitor. You will see a code of the \\
	corresponding button you pressed.<br><br>Note the codes on a paper or copy them in a \\
	document file on PC. `,
	
	`Here, You can learn "How to Control Motors using L298n Motor Driver & Arduino Uno".<br>You \\
	can even control Speed & Direction of Motors using this tutorial.<br><br>Additionally, I \\
	am Attaching a Video for your proper guidance.<br>You can see Step by Step Process \\
	physically- <br><img \\
	src="https://projects.arduinocontent.cc/f50108d1-ac6d-4d5f-acb5-90ca5a093cd4.jpg"></img><br>Here, \\
	I am attached a L298n Motor Driver Pinout Diagram- <br><img \\
	src="https://projects.arduinocontent.cc/918a766f-aeb8-4f94-aeda-57f183d1cf86.jpg"></img><br>Firstly, \\
	Connect your Motors with L298n Motor Driver <br><img \\
	src="https://projects.arduinocontent.cc/e0fd14ab-6166-4870-ad6e-b73c47009d86.png"></img><br>Now, \\
	Connect your L298n Pins with Arduino Uno Pins <br><img \\
	src="https://projects.arduinocontent.cc/7d20b0ad-496b-4a90-80ce-669ec9db1fd2.png"></img><br>Now, \\
	Connect following Pins-<br><br>L298n (+5V) =>Arduino (+5V)<br>L298n (Gnd) =>Arduino \\
	(Gnd)<br><br>Now Connect Battery-<br><br>L298n (+12V) =>Battery (+ve)<br>L298n (Gnd) \\
	=>Battery (-ve)<br><br>Above Pin System can Run your L298n Motor Driver module as well as \\
	Arduino.<br><br>But, If you want to Control Speed you have to do some simple extra work. \\
	<br><img \\
	src="https://projects.arduinocontent.cc/a73bfc9c-7c69-44fa-9d0f-321e034d6f4e.png"></img><br>Now \\
	You can Control your Motor Speed.<br>I am attached my Final Look of our Project. <br><img \\
	src="https://projects.arduinocontent.cc/601919da-0dc7-4158-9e4c-66e1192c1e0e.jpg"></img><br>`,
	
	`Hello everyone,<br><br>       Welcome back to another interesting and easy tutorial after \\
	...
	approx took 1 year and 2 months.<br><br>       Well back to the point, many years ago I \\
	...
	which is pushing me to work beyond my commitment.<br><br>       So in this tutorial I am \\
	...
	temperature and humidity anywhere in the world with the help of Arduino IoT Cloud.<br><br> \\
		  Buckle up, guys, and collect the MKR WiFi 1010 and DHT22 with male-to-male cables. \\
	Connect the DHT22 to the MKR WiFi 1010 as per the below diagram. <br><img \\
	src="https://projects.arduinocontent.cc/28e6dbad-bfb6-42fb-baad-7b7741ca689f.png"></img><br>It's \\
	...
	below image. <br><img src="https://i.imgur.com/7UPq84L.png"></img><br>Now click on + \\
	CREATE THING button which is shown in the center of the page as per below image. <br><img \\
	src="https://projects.arduinocontent.cc/16c97c36-b414-4a56-8fd3-e23096496af0.png"></img><br>After \\
	...
	device, network configuration, code and etc. <br><img \\
	src="https://projects.arduinocontent.cc/1fd770d1-3d82-40eb-8c59-947fbf6f7097.png"></img><br>Above \\
	...
	rename and assign the name to Thing.<br><br>2-In this section we will add the cloud \\
	variables and in this tutorial we required 2 cloud variables one for temperature and \\
	second for humidity.<br><br>3-Attach the device to Thing<br><br>4-Configure the Network \\
	Settings<br><br>5-Navigate to the Sketch tab and add the code for MKR Wi-Fi 1010 and \\
	upload the code.<br><br>Adding Variables to Thing<br><br>In this subsection, we will add \\
	...
	from the drop-down menu as per below image. <br><img \\
	src="https://i.imgur.com/dicxo6D.png"></img><br>Adding Device to Thing<br><br>Before \\
	...
	you have option to Add a new Device.<br><br>Click on "SET UP NEW DEVICE" and select the \\
	...
	board with the necessary configuration.. <br><img \\
	src="https://projects.arduinocontent.cc/05ec1b63-62b2-4291-865d-b2913f924809.png"></img><br>Congrats \\
	your Device has been added and attached successfully to Thing.<br><br>Configure Network \\
	for Thing<br><br>After adding the device it's time to configure the Wi-Fi Settings. Click \\
	on Configure button under Network section on the Thing main page. Here you will see the \\
	popup just like below image and you need to provide Wi-Fi Name and it's Password. <br><img \\
	src="https://projects.arduinocontent.cc/0fc35297-5efc-435f-901f-c858d7452bf5.png"></img><br>After \\
	...
	thing, and, at the end, added the Wi-Fi configuration. <br><img \\
	src="https://projects.arduinocontent.cc/5d5f5477-809e-42d9-84cd-701b533534b9.png"></img><br>Playing \\
	with the Code<br><br>Now it's time to play with the code. Just click on the Sketch tab and \\
	...
	development board. <br><img \\
	src="https://projects.arduinocontent.cc/f1db379f-444e-46a7-94bd-5319e03c68af.png"></img><br>Congrats \\
	now your devices is up and running and successfully sending the values to Arduino IoT \\
	Cloud.<br><br>Dashboard creation<br><br>In the previous tutorial, we just created and set \\
	up the thing. Now it's time to visualize the sensor readings. For this, we need to setup \\
	the dashboard. Click on the Dashboards menu, as shown in the below picture. <br><img \\
	src="https://i.imgur.com/FFgR2Uv.png"></img><br>Now you will see the Dashboard page just \\
	like below image and click on + CREATE DASHBOARD. <br><img \\
	src="https://projects.arduinocontent.cc/4cd7e377-a7d3-451b-9ecd-1cbef4297c7c.png"></img><br>You \\
	will see the new tab where you can setup the control widgets to visualize your sensor \\
	values. But here I marked down some important icons and buttons with numbers. <br><img \\
	src="https://projects.arduinocontent.cc/ebe991fd-7885-43c2-9646-c80cd9a7e734.png"></img><br>1- \\
	Click Untitled to rename and assign a name to your Dashboard<br><br>2-Eye icon is view \\
	mode while edit icon allows you to add/update the widgets and their settings.<br><br>3-ADD \\
	...
	control.<br><br>4-Reize icon will be used to resize the control and lock the alignment \\
	while mobile icon is used to prepare your dashboard according to mobile device, as by \\
	default you are creating dashboard for desktop.<br><br>Adding Widgets to \\
	Dashboard<br><br>Now it's time to add some widgets to visualize our Temperature and \\
	...
	variable. <br><img \\
	src="https://projects.arduinocontent.cc/c7be9925-ce5c-45a3-95cd-cf87f62500e8.png"></img><br>After \\
	giving the Name to widget control and linking the cloud variable setup will look like \\
	below image. just click on "DONE" and you will be good to go. <br><img \\
	src="https://projects.arduinocontent.cc/280dde65-b44c-40d6-b004-eca0605b5706.png"></img><br>Repeat \\
	...
	values. <br><img \\
	src="https://projects.arduinocontent.cc/b84f52b0-0581-4630-96d5-7e3c93579335.png"></img><br>Arduino \\
	IoT Cloud for Developers Book<br><br>Download the Arduino IoT Cloud app on your \\
	Android/Apple via Play/App store and login with your account and see the dashboard on \\
	fingertips for latest update and alerts.<br><br>Now it's time to talk about my Arduino IoT \\
	Cloud for Developers book which is by the available at amazon as well as on PacktPub. \\
	Below are the URLS for your purchase. \\
	https://www.amazon.com/Arduino-Cloud-Developers-simple-complex/dp/1837637172<br><br>https://www.packtpub.com/product/arduino-iot-cloud-for-developers/9781837637171The \\
	...
	started with the Arduino IoT Cloud.<br><br>I have created 6 different projects in the book \\
	...
	tutorial.<br><br>For developers and IoT engineers, I have written two special chapters \\
	...
	`The goal of this tutorial is to show you a way to easily add AI to a project , without any \\
	knowledge in this field, using the software NanoEdge AI Studio and its Arduino compatible \\
	libraries!<br><br>This tutorial guides you through building a cardboard touchpad that \\
	relies on vibration analysis and an Embedded AI algorithm running on an Arduino UNO R4 . \\
	The UNO emulates a USB keyboard device.<br><br>Vibration data from the cardboard is \\
	captured using a basic accelerometer connected via the Qwiic connector. Within the UNO \\
	microcontroller, vibrations are classified using a NanoEdge AI library.<br><br>Based on \\
	the detected class, the touchpad triggers either a "PageUp" or "PageDown" keystroke. \\
	NanoEdge AI Studio:<br><br>NanoEdge is a free machine learning software developed by \\
	...
	library.<br><br>In Nanoedge AI Studio, four kinds of projects are available, each serving \\
	a different purpose:<br><br>Anomaly detection (AD): to detect a nominal behavior and an \\
	abnormal one. Can be retrained directly on board.<br><br>1 class classification (1c): \\
	Create a model to detect both nominal and abnormal behavior but with only nominal data. \\
	(In case you cannot collect abnormal examples)<br><br>N class classification (Nc): Create \\
	a model to classify data into multiple classes that you define<br><br>Extrapolation (Ex): \\
	Regression in short. To predict a value instead of a class from the input data (a speed or \\
	temperature for example).Open Arduino IDE and create a new project:<br><br>Copy data \\
	logger source code available below. Click on Sketch > Include Library > Adafruit_LiS3DH to \\
	install the library.<br><br>Be careful : If your board is emulating a keyboard, you need \\
	to double press the reset button to be able to flash it.<br><br>Open the serial in Arduino \\
	IDE to check that the accelerometer data is correctly coming to your computer. (don't \\
	forget to close the serial after that) <br><img \\
	src="https://projects.arduinocontent.cc/aa31e081-1080-46bd-9b6e-084e16cdb658.png"></img><br>Now \\
	we will automatically create an AI model able to recognize classes of gestures using \\
	vibration patterns.<br><br>Open NanoEdge AI Studio and create a new " N-Class \\
	Classification " project.<br><br>In project settings:<br>Set target to "UNO R4 Wifi" \\
	Sensor to 3-axes accelerometer <br><img \\
	src="https://projects.arduinocontent.cc/036751c3-350c-47b5-be56-df2478d69917.png"></img><br>In \\
	...
	dataset!<br><br>Here is how to proceed:<br><br>Make sure the board is connected to the pc \\
	with the data logger code flashed on it<br><br>Click ADD SIGNAL > FROM SERIAL Make sure to \\
	select the right come port<br><br>Click START/STOP to collect data (100 buffers per signal \\
	should be enough) Once finished click CONTINUE and then IMPORT<br><br>If everything is \\
	correct, you should see a new dataset added with plots and information. <br><img \\
	src="https://projects.arduinocontent.cc/73727b45-b30a-4b8a-940c-5be372c72dbf.png"></img><br>Create \\
	the AI model:<br><br>Once you have all the classses that you want to recognize, go to the \\
	Benchmark step.<br><br>Click RUN NEW BENCHMARK. Select all your datasets and click \\
	START.<br><br>NanoEdge AI Studio will take your data and look for a model that is able to \\
	classify them. (it also applies pretreatment on its own to your data)<br><br>You get the \\
	accuracy of the model and its RAM and Flash requirements.<br><br>You should reach around \\
	99% pretty fast if you collected good data. You can stop the benchmark when it happens. \\
	<br><img \\
	src="https://projects.arduinocontent.cc/ae3a036a-2afe-4aee-9708-dbc2d1ae5447.png"></img><br>In \\
	the validation step, you can compare the libraries (model + preprocessing) if you want, \\
	look here for more \\
	info:<br>https://wiki.st.com/stm32mcu/wiki/AI:NanoEdge_AI_Studio#Validation<br><br>Test \\
	the model:<br><br>The emulator step is more useful for us here, you can use the serial to \\
	test the model directly in the tool:<br><br>Click INITIALIZE EMULATOR <br>Click FROM \\
	SERIAL<br>Test your model with new real time data <br><img \\
	src="https://projects.arduinocontent.cc/934034b2-cf67-4208-9e4a-d68e9b15193e.png"></img><br>The \\
	last step in NanoEdge is to get the AI library that we will use in Arduino IDE:<br>Click \\
	COMPILE LIBRARY<br><br>Get and extract the .zip file<br><br>The library is the .zip file \\
	in the folder Arduin , we will use it below: <br><img \\
	src="https://projects.arduinocontent.cc/cb1cadc0-a02d-4521-8e0d-d0ff4042e45b.png"></img><br>Create \\
	the demo:<br>Open a new project in Arduino IDE<br><br>Get the main code below and paste it \\
	in your project<br><br>Click on Sketch > Include Library > Adafruit_LIS3DH<br><br>Add the \\
	Nanoedge AI Library (select the previously extracted zip): <br><img \\
	src="https://projects.arduinocontent.cc/a36090e3-13ae-4859-9646-2c6c1d15da6a.png"></img><br>Compile \\
	the code. Flash the code.<br><br>It is finished, you can play with it.<br><br>Through this \\
	...
	interfacing it with Arduino.<br><br>In this project we will create a motion detection \\
	...
	alarm.<br><br>Understanding PIR Sensor<br><br>Before we dive into the project \\
	...
	amplifies this signal to detect motion.<br><br>HCSR04 Ultrasonic Sensor Pinout<br>The \\
	Pinout is given as below: `,
	
	`<br><img \\
	src="https://projects.arduinocontent.cc/947a4793-1603-4d45-b9fa-e314f780e848.jpg"></img><br>VCC \\
	is the power pin of the module.<br><br>GND is the GND pin of the module.<br><br>Out is the \\
	data output pin of the module.<br><br>Interfacing PIR Sensor with Arduino<br><br>Now that \\
	we have a basic understanding of how PIR sensors work, let's proceed to interface the PIR \\
	sensor with Arduino. Here's a step-by-step guide: <br><img \\
	src="https://projects.arduinocontent.cc/f3b88737-328c-4ace-bd4c-76b95195d2a6.jpg"></img><br>Connect \\
	...
	LCD displays.<br><br>#include <LiquidCrystal.h> // Include the LiquidCrystal library for \\
	...
	represent (RS, EN, D4, D5, D6, D7) pins respectively.<br><br>LiquidCrystal lcd(12, 11, 6, \\
	...
	sensor, and sensorReturn, which will store the output of the PIR sensor.<br><br>int \\
	sensorInput = 2;   // PIR sensor input pin<br>int sensorReturn = 0;  // Variable to store \\
	PIR sensor output<br><br>The setup() function is called once when the Arduino board \\
	...
	displayed on the LCD. <br><br>void loop() {      <br>	 sensorReturn = \\
	...
	lcd.print("Motion Stops    ");      <br>	 }      <br>}      `,
	
	`The two eyes are painted on two ping-pong balls which are sticked on two servo motors. Two \\
	...
	accordingly.<br><br>The servo motors are SG90 micro servos and the ultrasonic sensors are \\
	...
	and the ultrasonic sensors. <br><img \\
	src="https://projects.arduinocontent.cc/781dcb46-650d-4a7d-9177-5f7e4ee1ee1b.jpg"></img><br>The \\
	servo motors and ultrasonic sensors are sticked on a plate according to the arrangement \\
	shown on the following plan: <br><img \\
	src="https://projects.arduinocontent.cc/e0fd7c1d-3a35-474b-b284-60a1b0a110d3.jpg"></img><br>The \\
	...
	cm.<br><br>The connections to be made are as follows:<br><br>The grounds of the servo \\
	motors and of the ultrasonic sensors must be connected to the ground of the Arduino board \\
	and their power supplies to +5V.<br><br>The trigger input of the X ultrasonic sensor is \\
	connected to digital input/output 2 and its echo output to digital input/output \\
	3.<br><br>The trigger input of the Y ultrasonic sensor is connected to digital \\
	input/output 5 and its echo output to digital input/output 6.<br><br>The left and right \\
	servomotors controls are connected to digital inputs/outputs 8 and 10 respectively. Left \\
	and right refer to Big Brother's eyes, his left eye is on your own right.<br><br>The \\
	following diagram shows the connections to be made:Software<br><br>The software is \\
	extremely simple, less than 70 lines. No library is required.<br><br>Have fun. `,
	
	`Gather your tools and troops (components, that is)<br><br>The brains: An Arduino Uno, the \\
	...
	course!). <br><img \\
	src="https://circuitdigest.com/sites/default/files/circuitdiagram_mic/Arduino-Robot-Circuit-Diagram.png"></img><br>Craft \\
	the chassis, the car's core:<br><br>       Imagine your robot's frame. Sunboard is your \\
	...
	masterpiece. Motor magic, let the wheels spin:<br><br>       Time to get those motors \\
	...
	with dazzling LEDs:<br><br>       Let your creativity shine! Place the NeoPixel LEDs on \\
	...
	commands, unlock the moves:<br><br>       The Arduino code is the secret sauce that brings \\
	...
	`The ultrasonic sensor is a device that can measure distances using sound waves . It works \\
	in a similar way than bats and dolphins - by emitting sound waves and listening them bound \\
	back <br><img \\
	src="https://projects.arduinocontent.cc/cc7047f6-2bbf-43ed-87e9-76b07f4522e8.jpg"></img><br><br><img \\
	src="https://projects.arduinocontent.cc/8ab8bfd4-b0b9-42e1-9309-4f2a734ad439.jpg"></img><br>The \\
	...
	<br><br>When the sound wave hits an object, it bounces back like echo. This returning wave \\
	...
	<br><br>Using code, we can write a program that will store the timing between those two \\
	events into a variable. Then, we can use this information to calculate the distance \\
	between the sensor and the object. <br><br>You may be thinking: how can we find the \\
	distance if all we know is the timing? <br><br>Well, as you know, velocity is distance \\
	...
	the speed of sound in air (340 m/s). <br><br>Velocity = Distance / Time <br>Distance = \\
	Velocity * Time <br><br>But if we multiply this speed with the timing we found, we'll \\
	...
	<br><br>Distance = (Velocity * Time) / 2 <br><img \\
	src="https://projects.arduinocontent.cc/328c3323-cf29-434e-baf4-4c5b60eb5216.png"></img><br><br><img \\
	src="https://projects.arduinocontent.cc/328c3323-cf29-434e-baf4-4c5b60eb5216.png"></img><br><br><img \\
	src="https://projects.arduinocontent.cc/50ba2ab9-a2a5-4649-b4d1-553464059068.png"></img><br>In \\
	...
	<br><br>Moving on, for this project, you'll need: an Arduino board, a breadboard, a bunch \\
	of jumper wires, a buzzer,and an ultrasonic sensor. <br><br>Assembly<br><br>Firstly, \\
	attach the ultrasonic sensor and the buzzer on the breadboard. Then connect the VCC and \\
	GND pins on Arduino 5V and ground ports. <br><img \\
	src="https://projects.arduinocontent.cc/5d9e9e7a-35dc-47be-91c5-7f2503be7949.jpg"></img><br>After \\
	that connect the trigger pin to port 9, the echo pin to port 10, and the buzzer to port 8. \\
	Also attach the buzzer GND to Arduino GND. <br><img \\
	src="https://projects.arduinocontent.cc/5d823b9b-7ca8-453f-846a-65d58515efce.jpg"></img><br>At \\
	the end, upload the alarm-system-arduino.ino file that I provided on this article, and now \\
	our alarm system is finished. <br><br>Code explanation<br><br>At first, we defined the \\
	...
	to visualize the distances being measured. <br><img \\
	src="https://projects.arduinocontent.cc/96e0a1f3-94ba-4045-a270-a0fb390afa0d.png"></img><br>At \\
	...
	generate the wave sound that will be bounced back by the near objects.<br><br>At line 28 \\
	...
	After that, from lines 30 to 35 we print the distance. <br><br>The last part of the code \\
	is an if-statement that turns on the buzzer when the object is at 50 centimeters or closer \\
	from the sensor. In case this statement is false, the buzzer turns down. `,
	
	`This project is for a school code quest. I have seen many projects with soil moisture \\
	...
	that seems to also be working well. <br><br>How it works: <br><br>It works, when \\
	...
	Arduino can use that for the program. <br><br>The Soil Moisture Sensor needs to know the \\
	...
	switched on. <br><br>Here are some photos of the circuit without the casing: <br><img \\
	src="https://projects.arduinocontent.cc/bb269a1e-9020-4253-8e6d-a38f7fd4298d.JPG"></img><br><br><img \\
	src="https://projects.arduinocontent.cc/353ed111-13e9-476c-9417-12ed55022db5.JPG"></img><br><br><img \\
	src="https://projects.arduinocontent.cc/82d28236-fed8-454e-af83-fc25fc94a1c5.JPG"></img><br>The \\
	...
	Casing: <br><br>The casing is a simple box, with the LEDs coming out of the top, and the \\
	buzzer on the side. The Soil Moisture Sensor comes out of the side with wires and is stuck \\
	into the soil, so it's relatively far from all the water-sensitive components. `,
	
	`I needed to turn on and off some AC units located in a remote house, so that I can \\
	pre-cool (or pre-heat) the rooms in advance before I go. <br><br>Such units are very \\
	...
	and a USB cable: <br><img \\
	src="https://projects.arduinocontent.cc/87de5418-a5e8-43f6-9b42-0e000329fd22.jpg"></img><br>As \\
	...
	instructions. <br><br>So, if you have a Daikin AC like mine you can use my code below \\
	without changes. If you have another brand, follow these steps: <br><br>1. Find the name \\
	of the .h file related to your AC model. In my case, that's DaikinHeatpumpIR.h . \\
	<br><br>2. Replace DaikinHeatpumpIR.h and DaikinHeatpumpIR in my code with the name you \\
	found. <br><br>That's it! If you're lucky enough, you won't need to change other things. \\
	<br><br>The code I wrote supports heat/cool/dry modes as well as temperature \\
	...
	read by the AC unit. Remote control<br><br>Last but not least, I used the Arduino IoT \\
	Cloud to build a simple graphic interface to send commands remotely. To do this, follow \\
	these steps: <br><br>1. Open Arduino IoT Cloud and create a free account if you don't have \\
	one. <br><br>2. Create a device and select "M5Stack-ATOM" as the model. Make sure you save \\
	...
	and configure WiFi credentials for it. <br><br>4. Configure two variables in the thing: \\
	<br>a string variable called mode an integer variable called temperature <br><br>5. Copy \\
	the sketch code in the "Sketch" tab and upload it to the board. <br><br>6. Create a \\
	dashboard like this: <br><img \\
	src="https://projects.arduinocontent.cc/5d147029-cc54-4c89-8060-d6c4b3964cb4.png"></img><br>That's \\
	it. Enjoy! ❄️ <br>Over-the-air updates<br><br>In case you want to modify the code after \\
	...
	upload it to the board over WiFi (and even remotely). <br><br>Optional: closing the \\
	loop<br><br>When controlling remote things, it is always a good idea to put some sensors \\
	...
	<br>and can be done with a MKR WiFi 1010 board, a MKR ENV Shield, and IoT Cloud. `,
	...
	width modulation (PWM) signals. <br><br>RGB LED Types and Structure <br><br>RGB LEDs have \\
	...
	the PWM frequency. In other words, with Arduino's PWM frequency at about 500Hz, the green \\
	lines would measure 2 milliseconds each. <br><img \\
	src="https://projects.arduinocontent.cc/79c61371-7a80-4395-9e08-a4305376229c.gif"></img><br> \\
	Explanation of the Changes from the Original Version of this Project:<br><br>Button \\
	Input:<br><br>A button is connected to pin 2 of the Arduino, and it is configured with an \\
	...
	Logic:<br><br>Each time the button is pressed, the colorIndex variable is incremented, \\
	cycling through six different colors. After the last color, the index resets to \\
	zero.<br>Debouncing:<br><br>A small delay (delay(300)) is added after each button press to \\
	debounce the button, preventing multiple triggers from a single press.<br><br>This \\
	modification allows the RGB LED to change colors each time the button is pressed, \\
	providing interactive control over the LED.<br><br>Below is the schematic for my version \\
	of the project<br><img \\
	src="https://hackster.imgix.net/uploads/attachments/340746/button_push_color_change_UM2JWnHSDv.JPG"></img><br>The \\
	code below will allow you to cycle the LED through different colors by pushing a button, \\
	enjoy!`,
	
	`To modify the origional project created by dleibe1 and include an OLED display that shows \\
	...
	automations to smart watches. <br><br>What is humidity?<br><br>Humidity is the water vapor \\
	...
	except the last one, you're in space or you're in the middle of a desert**. <br><br>* \\
	Correction: it means the air cannot hold any more water. <br><br>**  The air in a desert \\
	does contain some water but it is a very little amount compared to a normal place. The \\
	Sahara Desert has a mean humidity of 25%. <br><br>The world's lowest recorded relative \\
	humidity value occurred at Coober Pedy in the South Australia desert when the temperature \\
