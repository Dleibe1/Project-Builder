...
class InstructionsSeeder {
  static async seed() {
    await Instruction.query().insert([
      {
projectId: 1,
instructionHTML: `<div><p>This project is made for Arduino beginners who are looking to learn how to interface  \
...
src="https://projects.arduinocontent.cc/6ce54a92-5d7b-4a79-9bb9-14646cee8d8d.png"></div>`
},
{
projectId: 1,
instructionHTML: `<div><p>Common  \
...
src="https://projects.arduinocontent.cc/50bfbc76-b401-44e6-8806-4c07057a4c63.png"></div>`
},
{
projectId: 1,
instructionHTML: `<div><p>Common  \
...
terminal of the power supply. </p><br><img  \
src="https://projects.arduinocontent.cc/a402677b-ba8b-4441-a052-cda5b140852b.png"></div>`
},
{
projectId: 1,
instructionHTML: `<div><p>Basics  \
...
src="https://projects.arduinocontent.cc/79c61371-7a80-4395-9e08-a4305376229c.gif"></div>`
},
{
projectId: 1,
instructionHTML: `<div><p>The  \
code below will cycle the LED through different colors, enjoy!</p></div>`
},
{
projectId: 2,
instructionHTML: `<div><p>Ever wanted to know the temperature and humidity around you? If yes, this project will  \
...
{
projectId: 3,
instructionHTML: `<div><p>Water deposit</p><br><p>For our watering system, we will need a water container. Any common  \
...
src="https://www.hibit.dev/images/posts/2024/watering_bottle.png"></div>`
},
{
projectId: 3,
instructionHTML: `<div><p>We've selected  \
...
src="https://www.hibit.dev/images/posts/2024/watering_bottom.png"></div>`
},
{
projectId: 3,
instructionHTML: `<div><p>On the  \
...
src="https://www.hibit.dev/images/posts/2024/watering_bottle_pump_connector.png"></div>`
},
{
projectId: 3,
instructionHTML: `<div><p>This  \
...
src="https://www.hibit.dev/images/posts/2024/watering_box.png"></div>`
},
{
projectId: 3,
instructionHTML: `<div><p>The box is easily  \
...
src="https://www.hibit.dev/images/posts/2024/watering_station.png"></div>`
},
{
projectId: 3,
instructionHTML: `<div><p>These  \
...
src="https://www.hibit.dev/images/posts/2024/schemas/watering_system.png"></div>`
},
{
projectId: 3,
instructionHTML: `<div><p>The  \
...
src="https://www.hibit.dev/images/posts/2024/watering_system_result.png"></div>`
},
{
projectId: 3,
instructionHTML: `<div><p>The  \
...
src="https://www.hibit.dev/images/posts/2023/arduino_import_library.png"></div>`
},
{
projectId: 3,
instructionHTML: `<div><p>Then  \
...
{
projectId: 4,
instructionHTML: `<div><p>The spectrum analyzer displays the amplitude of signals as a function of frequency,  \
...
src="https://projects.arduinocontent.cc/4e0bc386-4bd4-467a-8b59-084830978a17.jpg"></div>`
},
{
projectId: 4,
instructionHTML: `<div><p>The  \
...
src="https://projects.arduinocontent.cc/e5bffdf1-c174-47b2-aaeb-0edf30fec098.jpg"></div>`
},
{
projectId: 4,
instructionHTML: `<div><p>Next,  \
...
materials. </p><br><img  \
src="https://projects.arduinocontent.cc/68e9de6f-5336-42bc-be80-c50441f2808b.jpg"></div>`
},
{
projectId: 4,
instructionHTML: `<div><p>Namely,  \
...
src="https://projects.arduinocontent.cc/c3d1c115-d49f-4b94-9b96-13111be626e6.jpg"></div>`
},
{
projectId: 4,
...
{
projectId: 5,
instructionHTML: `<div><p>In the vast realm of robotics, enthusiasts are venturing into the exciting world of OLED  \
...
src="https://projects.arduinocontent.cc/414272c9-2c90-4576-9430-7599672fbcda.jpg"></div>`
},
{
projectId: 5,
instructionHTML: `<div><p>Intellar's  \
...
src="https://projects.arduinocontent.cc/dc1bda48-7902-4555-9369-708247c04e14.jpg"></div>`
},
{
projectId: 5,
instructionHTML: `<div><p>SpiderMaf's  \
...
src="https://projects.arduinocontent.cc/3f6ae98e-f7e9-40d2-8573-c242dc66d89c.jpg"></div>`
},
{
projectId: 5,
instructionHTML: `<div><p>Akno  \
...
src="https://projects.arduinocontent.cc/2596309e-914d-4907-b5a0-b940e3bc6f7b.jpg"></div>`
},
{
projectId: 5,
instructionHTML: `<div><p>Vinny's  \
...
src="https://projects.arduinocontent.cc/cff99131-f7ce-4295-b530-811e057734de.jpg"></div>`
},
{
projectId: 5,
instructionHTML: `<div><p>Picaio  \
...
{
projectId: 6,
instructionHTML: `<div><p>Greetings everyone, and welcome to my Instructables tutorial. Today, I'll guide you  \
...
src="https://projects.arduinocontent.cc/16e51e8c-81e8-4931-be46-69505c3bacd1.jpg"></div>`
},
{
projectId: 6,
instructionHTML: `<div><p>Refer  \
...
src="https://projects.arduinocontent.cc/00e1a573-4371-49bf-ba42-6884f62999ad.png"></div>`
},
{
projectId: 6,
instructionHTML: `<div><p>Follow  \
...
src="https://projects.arduinocontent.cc/fdab1aff-be31-4855-9328-99ec1bb9e356.jpg"></div>`
},
{
projectId: 6,
instructionHTML: `<div><p>Follow  \
...
src="https://projects.arduinocontent.cc/db48a4f0-129b-4770-8e19-9e81f5a8c29d.png"></div>`
},
{
projectId: 6,
instructionHTML: `<div><p>Follow  \
...
src="https://projects.arduinocontent.cc/efbbe392-9df2-476e-8470-157bd5dd834d.jpg"></div>`
},
{
projectId: 6,
instructionHTML: `<div><p>-  \
Now connect the USB cable to the Arduino Uno.<br>Next, upload the following code:</p></div>`
},
{
projectId: 7,
instructionHTML: `<div><p>About the Project</p><br><p>Welcome back, tech enthusiasts! Today, I'm excited to introduce  \
...
src="https://projects.arduinocontent.cc/88d1456c-cb9c-4a24-8b67-44c7d5ea7dc9.jpg"></div>`
},
{
projectId: 7,
instructionHTML: `<div><p>Atmega32u4  \
...
src="https://projects.arduinocontent.cc/0b6d0eeb-6a94-4fd1-9568-654934207c4a.png"></div>`
},
{
projectId: 7,
instructionHTML: `<div><p>Connection  \
...
src="https://projects.arduinocontent.cc/519e6eda-d64e-4e1a-a08e-b4eff9fc6ea5.jpg"></div>`
},
{
projectId: 7,
instructionHTML: `<div><p>Conclusion<br>Creating  \
...
{
projectId: 8,
instructionHTML: `<div><p>Ultrasonic sonar is devices that use sound waves with frequencies higher than the upper  \
...
src="https://projects.arduinocontent.cc/77c2652f-24f9-4051-b804-ee01d27a19fb.jpg"></div>`
},
{
projectId: 8,
instructionHTML: `<div><p>The  \
...
src="https://projects.arduinocontent.cc/551833cf-1265-4704-b8ed-624bc04e00fc.jpg"></div>`
},
{
projectId: 8,
instructionHTML: `<div><p>Now  \
...
src="https://projects.arduinocontent.cc/3332450b-d347-4c5c-871c-e1d3c5db8c73.jpg"></div>`
},
{
projectId: 8,
instructionHTML: `<div><p>Now  \
...
begins. </p><br><img  \
src="https://projects.arduinocontent.cc/58696a6b-fc25-414b-bd8d-8fb2244937a5.jpg"></div>`
},
{
projectId: 8,
instructionHTML: `<div><p>Obstacles  \
...
src="https://projects.arduinocontent.cc/c08bc3f4-47b9-469f-a32a-07aa775c9549.jpg"></div>`
},
{
projectId: 8,
instructionHTML: `<div><p>For  \
...
{
projectId: 9,
instructionHTML: `<div><p>In this exciting tutorial, we will show you how to build your own security camera using an  \
...
src="https://rogerbit.com/wprb/wp-content/uploads/2021/07/51Lp3uhptQL.jpg"></div>`
},
{
projectId: 9,
instructionHTML: `<div><p>Description<br>FTDI  \
...
src="https://projects.arduinocontent.cc/ac0170b4-8181-4118-b8f2-1dc78673e266.jpg"></div>`
},
{
projectId: 9,
instructionHTML: `<div><p>Hookup<br>Follow  \
...
{
projectId: 10,
instructionHTML: `<div><p>Here,  \
I am attached a L298n Motor Driver Pinout Diagram- </p><br><img  \
src="https://projects.arduinocontent.cc/918a766f-aeb8-4f94-aeda-57f183d1cf86.jpg"></div>`
},
{
projectId: 10,
instructionHTML: `<div><p>Firstly,  \
Connect your Motors with L298n Motor Driver </p><br><img  \
src="https://projects.arduinocontent.cc/e0fd14ab-6166-4870-ad6e-b73c47009d86.png"></div>`
},
{
projectId: 10,
instructionHTML: `<div><p>Now,  \
Connect your L298n Pins with Arduino Uno Pins </p><br><img  \
src="https://projects.arduinocontent.cc/7d20b0ad-496b-4a90-80ce-669ec9db1fd2.png"></div>`
},
{
projectId: 10,
instructionHTML: `<div><p>Now,  \
...
src="https://projects.arduinocontent.cc/a73bfc9c-7c69-44fa-9d0f-321e034d6f4e.png"></div>`
},
{
projectId: 10,
instructionHTML: `<div><p>Now  \
...
{
projectId: 11,
instructionHTML: `<div><p>Hello everyone,</p><br><p>       Welcome back to another interesting and easy tutorial after  \
...
src="https://projects.arduinocontent.cc/28e6dbad-bfb6-42fb-baad-7b7741ca689f.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>It's  \
...
below image. </p><br><img src="https://i.imgur.com/7UPq84L.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>Now click on +  \
CREATE THING button which is shown in the center of the page as per below image. </p><br><img  \
src="https://projects.arduinocontent.cc/16c97c36-b414-4a56-8fd3-e23096496af0.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>After  \
...
src="https://projects.arduinocontent.cc/1fd770d1-3d82-40eb-8c59-947fbf6f7097.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>Above  \
...
src="https://i.imgur.com/dicxo6D.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>Adding Device to Thing</p><br><p>Before  \
...
src="https://projects.arduinocontent.cc/05ec1b63-62b2-4291-865d-b2913f924809.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>Congrats  \
...
src="https://projects.arduinocontent.cc/0fc35297-5efc-435f-901f-c858d7452bf5.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>After  \
...
src="https://projects.arduinocontent.cc/5d5f5477-809e-42d9-84cd-701b533534b9.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>Playing  \
...
src="https://projects.arduinocontent.cc/f1db379f-444e-46a7-94bd-5319e03c68af.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>Congrats  \
...
src="https://i.imgur.com/FFgR2Uv.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>Now you will see the Dashboard page just  \
like below image and click on + CREATE DASHBOARD. </p><br><img  \
src="https://projects.arduinocontent.cc/4cd7e377-a7d3-451b-9ecd-1cbef4297c7c.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>You  \
...
src="https://projects.arduinocontent.cc/ebe991fd-7885-43c2-9646-c80cd9a7e734.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>1-  \
...
variable. </p><br><img  \
src="https://projects.arduinocontent.cc/c7be9925-ce5c-45a3-95cd-cf87f62500e8.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>After  \
...
src="https://projects.arduinocontent.cc/280dde65-b44c-40d6-b004-eca0605b5706.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>Repeat  \
...
values. </p><br><img  \
src="https://projects.arduinocontent.cc/b84f52b0-0581-4630-96d5-7e3c93579335.png"></div>`
},
{
projectId: 11,
instructionHTML: `<div><p>Arduino  \
...
{
projectId: 12,
instructionHTML: `<div><p>The goal of this tutorial is to show you a way to easily add AI to a project , without any  \
...
src="https://projects.arduinocontent.cc/aa31e081-1080-46bd-9b6e-084e16cdb658.png"></div>`
},
{
projectId: 12,
instructionHTML: `<div><p>Now  \
...
src="https://projects.arduinocontent.cc/036751c3-350c-47b5-be56-df2478d69917.png"></div>`
},
{
projectId: 12,
instructionHTML: `<div><p>In  \
...
src="https://projects.arduinocontent.cc/73727b45-b30a-4b8a-940c-5be372c72dbf.png"></div>`
},
{
projectId: 12,
instructionHTML: `<div><p>Create  \
...
src="https://projects.arduinocontent.cc/ae3a036a-2afe-4aee-9708-dbc2d1ae5447.png"></div>`
},
{
projectId: 12,
instructionHTML: `<div><p>In  \
...
src="https://projects.arduinocontent.cc/934034b2-cf67-4208-9e4a-d68e9b15193e.png"></div>`
},
{
projectId: 12,
instructionHTML: `<div><p>The  \
...
src="https://projects.arduinocontent.cc/cb1cadc0-a02d-4521-8e0d-d0ff4042e45b.png"></div>`
},
{
projectId: 12,
instructionHTML: `<div><p>Create  \
...
src="https://projects.arduinocontent.cc/a36090e3-13ae-4859-9646-2c6c1d15da6a.png"></div>`
},
{
projectId: 12,
instructionHTML: `<div><p>Compile  \
...
src="https://projects.arduinocontent.cc/f3b88737-328c-4ace-bd4c-76b95195d2a6.jpg"></div>`
},
{
projectId: 13,
instructionHTML: `<div><p>Connect  \
...
{
projectId: 14,
instructionHTML: `<div><p>The two eyes are painted on two ping-pong balls which are sticked on two servo motors. Two  \
...
src="https://projects.arduinocontent.cc/781dcb46-650d-4a7d-9177-5f7e4ee1ee1b.jpg"></div>`
},
{
projectId: 14,
instructionHTML: `<div><p>The  \
...
src="https://projects.arduinocontent.cc/e0fd7c1d-3a35-474b-b284-60a1b0a110d3.jpg"></div>`
},
{
projectId: 14,
instructionHTML: `<div><p>The  \
...
{
projectId: 15,
instructionHTML: `<div><p>Gather your tools and troops (components, that is)</p><br><p>The brains: An Arduino Uno, the  \
...
course!). </p><br><img  \
src="https://circuitdigest.com/sites/default/files/circuitdiagram_mic/Arduino-Robot-Circuit-Diagram.png"></div>`
},
{
projectId: 15,
instructionHTML: `<div><p>Craft  \
...
{
projectId: 16,
instructionHTML: `<div><p>The ultrasonic sensor is a device that can measure distances using sound waves . It works  \
...
src="https://projects.arduinocontent.cc/8ab8bfd4-b0b9-42e1-9309-4f2a734ad439.jpg"></div>`
},
{
projectId: 16,
instructionHTML: `<div><p>The  \
...
src="https://projects.arduinocontent.cc/328c3323-cf29-434e-baf4-4c5b60eb5216.png"></img></p><br><p><img  \
src="https://projects.arduinocontent.cc/50ba2ab9-a2a5-4649-b4d1-553464059068.png"></div>`
},
{
projectId: 16,
instructionHTML: `<div><p>In  \
...
src="https://projects.arduinocontent.cc/5d9e9e7a-35dc-47be-91c5-7f2503be7949.jpg"></div>`
},
{
projectId: 16,
instructionHTML: `<div><p>After  \
...
src="https://projects.arduinocontent.cc/5d823b9b-7ca8-453f-846a-65d58515efce.jpg"></div>`
},
{
projectId: 16,
instructionHTML: `<div><p>At  \
...
src="https://projects.arduinocontent.cc/96e0a1f3-94ba-4045-a270-a0fb390afa0d.png"></div>`
},
{
projectId: 16,
instructionHTML: `<div><p>At  \
...
{
projectId: 17,
instructionHTML: `<div><p>This project is for a school code quest. I have seen many projects with soil moisture  \
...
src="https://projects.arduinocontent.cc/82d28236-fed8-454e-af83-fc25fc94a1c5.JPG"></div>`
},
{
projectId: 17,
instructionHTML: `<div><p>The  \
...
{
projectId: 18,
instructionHTML: `<div><p>I needed to turn on and off some AC units located in a remote house, so that I can  \
...
src="https://projects.arduinocontent.cc/87de5418-a5e8-43f6-9b42-0e000329fd22.jpg"></div>`
},
{
projectId: 18,
instructionHTML: `<div><p>As  \
...
src="https://projects.arduinocontent.cc/5d147029-cc54-4c89-8060-d6c4b3964cb4.png"></div>`
},
{
projectId: 18,
instructionHTML: `<div><p>That's  \
...
src="https://hackster.imgix.net/uploads/attachments/340746/button_push_color_change_UM2JWnHSDv.JPG"></div>`
},
{
projectId: 19,
instructionHTML: `<div><p>The  \
...
{
projectId: 20,
instructionHTML: `<div><p>To modify the origional project created by dleibe1 and include an OLED display that shows  \
...
sensor has 3 pins and it's fitted on a board. If yours has 4 pins, then you need to build  \
this circuit: </p><br><img  \
src="https://i.imgur.com/6sNtuUL.png"></div>`
},
{
projectId: 20,
instructionHTML: `<div><p>If  \
it is same as mine, then follow this diagram instead, you will no longer need the resistor:</p><br><img  \
src="https://i.imgur.com/xdSSgkL.png"></div>`
},
{
projectId: 20,
instructionHTML: `<div><p>Details about the code</p><br><p>You need to follow these instructions to  \
...
export default InstructionsSeeder
